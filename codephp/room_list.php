                                        ...
                                        <td>
                                            <div class="card">
                                               ...
                                               $oneresult = DB::query("SELECT * FROM Record, Booking WHERE Record.BookingID = Booking.BookingID AND Record.Room_Number = %i AND Record.Date = %s",$row['Room_Number'],date("Y-m-d"));
                                                ...
                                                ?>
                                                 <a href="current_stay.php?Room_Number=<?php echo $row['Room_Number']; ?>&Check_In_Date=<?php echo date("Y-m-d"); ?>" class="btn btn-primary btntext">
                                                <?php
                                                }
                                                ?>
                                                ...
                                                ?>
                                                 <a href="create_reservation.php?Room_Number=<?php echo $row['Room_Number']; ?>&Check_In_Date=<?php echo date("Y-m-d", strtotime('+1 day')); ?>" class="btn btn-secondary btntext">
                                                <?php
                                                }
                                                ?>
                                                ...
                                                ?>
                                                 <a href="create_reservation.php?Room_Number=<?php echo $row['Room_Number']; ?>&Check_In_Date=<?php echo date("Y-m-d", strtotime('+2 day')); ?>" class="btn btn-success btntext">
                                                <?php
                                                }
                                                ?>
                                                ...
                                                ?>
                                                 <a href="create_reservation.php?Room_Number=<?php echo $row['Room_Number']; ?>&Check_In_Date=<?php echo date("Y-m-d", strtotime('+3 day')); ?>" class="btn btn-danger btntext">
                                                <?php
                                                }
                                                ?>
                                                ...
                                                ?>
                                                 <a href="create_reservation.php?Room_Number=<?php echo $row['Room_Number']; ?>&Check_In_Date=<?php echo date("Y-m-d", strtotime('+4 day')); ?>" class="btn btn-warning btntext">
                                                <?php
                                                }
                                                ?>
                                                ...
                                                ?>
                                                 <a href="create_reservation.php?Room_Number=<?php echo $row['Room_Number']; ?>&Check_In_Date=<?php echo date("Y-m-d", strtotime('+5 day')); ?>" class="btn btn-info btntext">
                                                <?php
                                                }
                                                ?>
                                                ...
                                                ?>
                                                 <a href="create_reservation.php?Room_Number=<?php echo $row['Room_Number']; ?>&Check_In_Date=<?php echo date("Y-m-d", strtotime('+6 day')); ?>" class="btn btn-dark btntext">
                                                <?php
                                                }
                                                ?>
